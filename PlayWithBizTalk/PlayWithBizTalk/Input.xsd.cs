namespace PlayWithBizTalk {
    ...
    [Schema(@"http://dev.local/input",@"Root")]
    [BodyXPath(@"/*[local-name()='Root' and namespace-uri()='http://dev.local/input']")]
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns=""http://dev.local/input"" xmlns:r=""http://dev.local/recall"" elementFormDefault=""qualified"" targetNamespace=""http://dev.local/input"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:import schemaLocation=""PlayWithBizTalk.Recall"" namespace=""http://dev.local/recall"" />
  <xs:annotation>
    <xs:appinfo>
